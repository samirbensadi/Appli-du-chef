...
try {
  ...
  $bdd_app = new PDO('mysql:host=localhost;dbname=application;charset=utf8', 'root', 'pipi');
  $bdd_app->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
  $bdd_app->setAttribute(PDO::ATTR_DEFAULT_FETCH_MODE, PDO::FETCH_OBJ); // on modifie l'option pour que la requete soit fetchée en tant qu'objet
